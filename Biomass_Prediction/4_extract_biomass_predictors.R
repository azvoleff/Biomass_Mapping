...
predictors <- brick("D:/Biomass_Mapping/9_stacked_biomass_predictors/")
...
save(biomass_data, file="Data/neural_net_predictors_5x5_textures.Rdata")
write.csv(biomass_data, file="Data/neural_net_predictors_5x5_textures.csv")
